from utils.angle_compute import check_angle
from utils.distance_compute import distance

### From paper "Finding Squares and Rectangles in a Set of Points", M. Kreveld, M. Berg, http://www.cs.uu.nl/research/techreps/repo/CS-1989/1989-10.pdf ###
...
def find_squares_and_rectangles(points, distance_min, distance_max, angle_delta):
    """
    Main function for finding squares and rectangles in a set of points.
    Divides the plane into a quadtree and then queries the quadtree for subgroups of points.
